...
export default function BankPayTel() {
  ...
  return (
    <div className="w-3/5 h-2/3 flex items-center justify-around flex-col px-2.5 overflow-x-hidden overflow-y-auto align self-center mob:w-full ">
      ...
      <Collapse
        in={a === 1}
        sx={{ width: "100%", display: a === 1 ? "block" : "none" }}
        color="error"
      >
        <Alert
          severity="error"
          sx={{
            ...
            color: "rgb(220,178,178)",
            fontWeight: 600,
          }}
          action={
            <IconButton color="inherit" size="small" onClick={() => setA(0)}>
      ...
      <Collapse
        in={a === 2}
        sx={{ width: "100%", display: a === 2 ? "block" : "none" }}
        color="error"
      >
        <Alert
          severity="error"
      ...
      <Collapse
        in={a === 3}
        sx={{ width: "100%", display: a === 3 ? "block" : "none" }}
        color="error"
      >
        <Alert
          severity="error"
      ...
      <Collapse
        in={a === 4}
        sx={{ width: "100%", display: a === 4 ? "block" : "none" }}
        color="error"
      >
        <Alert
          severity="error"
      ...
      <Collapse
        in={a === 5}
        sx={{ width: "100%", display: a === 5 ? "block" : "none" }}
        color="error"
      >
        <Alert
          severity="success"
      ...
      {/* Btn */}
      <button
        className="w-full bg-[#4e0070] dark:bg-[#9220c2] text-white  rounded-xl  h-12 text-2xl font-bold items-center justify-center flex hover:h-[50px] hover:shadow-lg  dark:hover:shadow-lg transition-all duration-700 hover:bg-[#4e0070d6] dark:hover:bg-[#9220c2d6]"
        onClick={() => {
          setL(true);
          pay();
          {
